...
// Join dengan tabel users untuk mendapatkan nama customer
 $query = mysqli_query($conn, "SELECT o.*, u.full_name, u.id as customer_id FROM orders o JOIN users u ON o.user_id = u.id $whereClause ORDER BY o.id DESC");
?>
                    ...
                    <?php if (mysqli_num_rows($query) > 0): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <!-- TAMBAHAN: Tombol Chat Customer -->
                                <a href="admin_chat.php?user_id=<?= $row['customer_id'] ?>" class="btn-action btn-chat" title="Chat Customer">
