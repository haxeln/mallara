...
if (isset($_GET['delete'])) {
    ...
    // Cek apakah user ini bukan diri sendiri
                    ...
                    <tr>
                        ...
                        <td>
                            <?php 
                                ...
                                // Jika Role adalah Petugas, tampilkan tulisan "Petugas", bukan tombol hapus
                                if($row['role'] == 'petugas'): 
                            ?>
                                <small style="color:#999; font-weight: 600;">Your Self</small>
                            <?php else: ?>
                                <!-- Jika Bukan Petugas, tampilkan tombol hapus -->
