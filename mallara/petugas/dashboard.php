...
// Jika nama login adalah 'admin', ganti menjadi 'Petugas'
 $displayName = htmlspecialchars($_SESSION['full_name']);
if (strtolower($displayName) == 'admin') {
    $displayName = 'Petugas';
}
...
<head>
    ...
    <title>Petugas Dashboard - Mallara</title>
...
<body>
    ...
    <main class="main-content">
        <div class="admin-topbar">
            <!-- Perubahan disini: Menggunakan variabel $displayName -->
            <div class="welcome-text"><h1>Dashboard</h1><p>Halo, <?= $displayName ?></p></div>
        </div>
