...
<head>
    ...
    <title>Men's Collection - Mallara</title>
    ...
    <style>
        ...
        /* --- STYLE TOMBOL BACK BARU --- */
        .back-btn-fixed {
            position: fixed;
            top: 90px; /* Jarak dari atas (sesuaikan jika navbar tinggi) */
            left: 20px;
            width: 45px;
            height: 45px;
            background: white;
            ...
            z-index: 999; /* Supaya di atas grid produk */
        ...
        .card-img-top { 
            width: 100%; 
            height: 320px; 
            object-fit: contain; /* Supaya gambar tidak terpotong/gelembung */
        ...
        .detail-image-container { 
            width: 100%; 
            flex-shrink: 0; /* Gambar tidak mengecil saat discroll */
            height: 250px; 
            background: #fff; 
            margin-bottom: 20px; 
            border-radius: 15px; 
        ...
        .modal-info {
            /* PERBAIKAN SCROLL: Area inilah yang discroll */
            flex-grow: 1;
            overflow-y: auto; 
            min-height: 0; /* Kunci agar flex-child bisa discroll dengan benar */
            padding-right: 5px; 
            padding-bottom: 20px;
            
            /* Style Scrollbar agar modern/rapi */
        ...
        @media (max-width: 600px) { 
            ...
            .detail-image-container { height: 200px; }
            /* Mobile adjustment for back button */
            .back-btn-fixed { top: 70px; left: 15px; width: 40px; height: 40px; font-size: 18px; }
        }
    </style>
</head>
<body>
    ...
    <!-- 2. BACK BUTTON (NEW) -->
    <a href="<?= BASE_URL ?>index.php" class="back-btn-fixed" title="Back to Home">
        <i class="fas fa-arrow-left"></i>
    </a>

    <div class="container">
        <h2 class="page-title">Men's Collection</h2>
        
        <div class="product-grid">
            <?php while ($row = mysqli_fetch_assoc($query)): 
                $isOutOfStock = ($row['stock'] <= 0);
                
                // Path gambar ke folder 'man'
                $imgPath = BASE_URL . 'assets/img/products/man/' . $row['image'];
    ...
    <script>
        ...
        function openModal(type, id, name, price, stock, imgUrl) {
            ...
            document.getElementById('stockInfo').innerText = ' Stock: ' + currentStock;
